...
Shader "Kaima/Depth/ForceField1"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float rim;
                if (_RimPower < 0.5)
                    rim = 2 * _RimPower - saturate(dot(worldNormal, worldViewDir)) * 2 * (1 - _RimPower);
                else
                    rim = 1 - saturate(dot(worldNormal, worldViewDir)) * (1 - _RimPower) * 2;
